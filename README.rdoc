= redmine_revision_diff {<img src="https://codeclimate.com/github/mateusmedeiros/redmine_revision_diff/badges/gpa.svg" />}[https://codeclimate.com/github/mateusmedeiros/redmine_revision_diff]
...
This should work from Redmine 2.4.3 onwards. 
